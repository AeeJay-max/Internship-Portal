...
<head>
    ...
    <title>403 — Access Denied | MOSRAC</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        nav span { color: #c4b5fd; font-size: 0.68rem; display: block; font-weight: 400; }
        .container {
            flex: 1;
            display: flex;
            align-items: center;
        ...
        .btn-primary { background: white; color: #4c1d95; }
...
<div class="container">
    <div class="card">
        ...
        <h1>Access Denied</h1>
        <p>You don't have permission to view this page. Contact the admissions office if you think this is a mistake.</p>
        <div class="actions">
