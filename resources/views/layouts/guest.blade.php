...
<div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col items-center justify-center bg-[#0B120C] text-white">

        {{-- Zimbabwean Flag Top Accent Line --}}
        <div class="absolute top-0 left-0 right-0 h-2 flex">
            <div class="w-1/4 bg-[#005A2B]"></div>
        ...
        <div class="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#005A2B] via-[#00421F] to-[#0B120C] opacity-90"></div>

        {{-- Decorative Circles --}}
        <div class="absolute -top-20 -right-20 w-96 h-96 rounded-full bg-[#005A2B]/20 blur-2xl"></div>
        ...
        <div class="relative z-10 text-center px-12 max-w-lg">
            ...
            <div class="flex justify-center mb-6">
                <img src="{{ asset('images/branding/mosrac_logo.png') }}" alt="Ministry of Sport, Recreation, Arts and Culture Emblem" class="w-36 h-36 object-contain drop-shadow-2xl" onerror="this.onerror=null; this.src='{{ asset('images/branding/lionfalcon.png') }}';">
            </div>
            ...
            <p class="text-amber-400 font-bold text-lg mb-6">
                MoSRAC Internship Portal
            </p>

            <div class="w-16 h-1 bg-amber-400 mx-auto rounded-full mb-6"></div>

            <p class="text-emerald-100/90 text-xs leading-relaxed max-w-sm mx-auto">
            ...
            <div class="mt-8 grid grid-cols-2 gap-3 text-left">
                ...
                <div class="p-3 bg-white/5 border border-white/10 rounded-xl">
                    <p class="text-amber-300 font-bold text-xs">1 PDF File</p>
        ...
        <div class="absolute bottom-6 left-0 right-0 text-center">
            <a href="{{ url('/') }}" class="text-emerald-200/80 hover:text-amber-300 text-xs font-semibold transition-colors flex items-center justify-center gap-1.5">
    ...
    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 relative bg-slate-50">
        ...
        <div class="lg:hidden mb-6 text-center">
            <img src="{{ asset('images/branding/mosrac_logo.png') }}" alt="MoSRAC Emblem" class="w-20 h-20 object-contain mx-auto mb-2" onerror="this.onerror=null; this.src='{{ asset('images/branding/lionfalcon.png') }}';">
