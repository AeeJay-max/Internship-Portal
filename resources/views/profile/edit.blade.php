    ...
    <div class="max-w-4xl mx-auto px-6 py-12">
        ...
        <div class="mb-10">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold" style="color: #011C3E; font-family: 'Georgia', serif;">
                        {{ Auth::user()->name }}
                    </h1>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-8 py-5 border-b border-gray-100 flex items-center gap-3" style="background: #f8fafc;">
                    <div class="w-8 h-8 rounded-lg flex items-center justify-center" style="background: #e8f0fe;">
                        <svg class="w-4 h-4" style="color: #011C3E;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
